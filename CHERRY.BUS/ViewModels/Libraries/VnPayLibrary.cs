...
namespace CHERRY.BUS.ViewModels.Libraries
{
    public class VnPayLibrary
    {
        ...
        public OrderCreateVM GetFullResponseData(IQueryCollection collection, string hashSecret)
        {
